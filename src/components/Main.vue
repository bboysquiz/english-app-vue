...
const fetchWord = () => {
    axios
        .get(`https://english-iyve3zm8u-nikitas-projects-d648fed6.vercel.app/api/dictionary/random`)
        .then((res) => {
...
const fetchStats = () => {
    axios
        .get(`https://english-iyve3zm8u-nikitas-projects-d648fed6.vercel.app/api/users/points`)
        .then((res) => {
            if(res) {
    ...
    axios
        .get(`https://english-iyve3zm8u-nikitas-projects-d648fed6.vercel.app/api/users/correct_words`)
        .then((res) => {
            if(res) {
    ...
    axios
        .get(`https://english-iyve3zm8u-nikitas-projects-d648fed6.vercel.app/api/users/incorrect_words`)
        .then((res) => {
            if(res) {
...
const checkTranslation = async () => {
    ...
    if (input === translation.value.toLowerCase()) {
        ...
        points.value += 1
        axios
            .put(`https://english-iyve3zm8u-nikitas-projects-d648fed6.vercel.app/api/users/points`, {
                username: 'Squiz',
                points: points.value,
            })
            .then(() => {
        ...
        axios
            .put(`https://english-iyve3zm8u-nikitas-projects-d648fed6.vercel.app/api/users/correct_words`, {
                username: 'Squiz',
        ...
        axios
            .put(`https://english-iyve3zm8u-nikitas-projects-d648fed6.vercel.app/api/users/incorrect_words`, {
                username: 'Squiz',
